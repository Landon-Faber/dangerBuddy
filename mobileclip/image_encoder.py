...
from mobileclip.modules.image.image_projection import GlobalPool2D, ScrapProjectionHead
...
class MCi(nn.Module):
    ...
    def _update_image_classifier(
        ...
        new_img_classifier = ScrapProjectionHead(in_dim=in_features, out_dim=projection_dim)
