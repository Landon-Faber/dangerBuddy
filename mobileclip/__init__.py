...
def create_model_and_transforms(
    ...
    if pretrained is not None:
        ...
        chkpt["image_encoder.model.head.conv.weight"] = chkpt["image_encoder.model.head.proj"].permute(1, 0).unsqueeze_(-1).unsqueeze_(-1)
        chkpt.pop("image_encoder.model.head.proj", None)

        # chkpt["image_encoder.model.classifier.conv.weight"] = chkpt["image_encoder.model.classifier.proj"].permute(1, 0).unsqueeze_(-1).unsqueeze_(-1)
        # chkpt.pop("image_encoder.model.classifier.proj", None)
