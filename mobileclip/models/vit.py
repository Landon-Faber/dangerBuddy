...
from mobileclip.modules.image.image_projection import SimpleImageProjectionHead, ScrapProjectionHead
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, cfg, *args, **kwargs) -> None:
        ...
        if self.projection_dim is None:
            ...
            self.classifier = ScrapProjectionHead(embed_dim, self.projection_dim)
    ...
    def forward_classifier(self, x: Tensor, *args, **kwargs) -> Tuple[Tensor, Tensor]:
        ...
        cls_embedding = self.classifier(image_embedding)
